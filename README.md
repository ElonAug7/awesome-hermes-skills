...
- [famulor-assistants-history](https://github.com/bekservice/Famulor-Skill/tree/main/claude-store/skills/famulor-assistants-history) by [Famulor](https://github.com/bekservice) — Uses 11 read-only MCP tools to inspect Famulor assistants and unified call, messaging, and email history without write actions. **[beta]**
